...
class boss_IronJuggernaut : public CreatureScript
{
    public:
        boss_IronJuggernaut() : CreatureScript("boss_IronJuggernaut") { }

        struct boss_IronJuggernautAI : public ScriptedAI
        {
            boss_IronJuggernautAI(Creature* creature) : ScriptedAI(creature)
            {
                Initialize();
            }
        ...
        {
            return new boss_IronJuggernautAI(creature);
        }
};

void AddSC_boss_IronJuggernaut()
{
    new boss_IronJuggernaut();
}
