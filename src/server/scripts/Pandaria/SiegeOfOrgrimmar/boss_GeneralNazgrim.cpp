...
class boss_GeneralNazgrim : public CreatureScript
{
    public:
        boss_GeneralNazgrim() : CreatureScript("boss_GeneralNazgrim") { }

        struct boss_GeneralNazgrimAI : public ScriptedAI
        {
            boss_GeneralNazgrimAI(Creature* creature) : ScriptedAI(creature)
            {
                Initialize();
            }
        ...
        {
            return new boss_GeneralNazgrimAI(creature);
        }
};

void AddSC_boss_GeneralNazgrim()
{
    new boss_GeneralNazgrim();
}
