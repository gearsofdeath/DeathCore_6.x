...
class boss_KorKron : public CreatureScript
{
    public:
        boss_KorKron() : CreatureScript("boss_KorKron") { }

        struct boss_KorKronAI : public ScriptedAI
        {
            boss_KorKronAI(Creature* creature) : ScriptedAI(creature)
            {
                Initialize();
            }
        ...
        {
            return new boss_KorKronAI(creature);
        }
};
