...
class boss_ParagonsOfTheKlaxxi : public CreatureScript
{
    public:
        boss_ParagonsOfTheKlaxxi() : CreatureScript("boss_ParagonsOfTheKlaxxi") { }

        struct boss_ParagonsOfTheKlaxxiAI : public ScriptedAI
        {
            boss_ParagonsOfTheKlaxxiAI(Creature* creature) : ScriptedAI(creature)
            {
                Initialize();
            }
        ...
        {
            return new boss_ParagonsOfTheKlaxxiAI(creature);
        }
};

void AddSC_boss_ParagonsOfTheKlaxxi()
{
    new boss_ParagonsOfTheKlaxxi();
}
