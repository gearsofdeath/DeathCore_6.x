...
class boss_GarroshHellscream : public CreatureScript
{
    public:
        boss_GarroshHellscream() : CreatureScript("boss_GarroshHellscream") { }

        struct boss_GarroshHellscreamAI : public ScriptedAI
        {
            boss_GarroshHellscreamAI(Creature* creature) : ScriptedAI(creature)
            {
                Initialize();
            }
        ...
        {
            return new boss_GarroshHellscreamAI(creature);
        }
};

void AddSC_boss_GarroshHellscream()
{
    new boss_GarroshHellscream();
}
