...
class boss_ShaOfPride : public CreatureScript
{
    public:
        boss_ShaOfPride() : CreatureScript("boss_ShaOfPride") { }

        struct boss_ShaOfPrideAI : public ScriptedAI
        {
            boss_ShaOfPrideAI(Creature* creature) : ScriptedAI(creature)
            {
                Initialize();
            }
        ...
        {
            return new boss_ShaOfPrideAI(creature);
        }
};
