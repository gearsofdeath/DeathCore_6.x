...
class boss_TheFallenProtectors : public CreatureScript
{
    public:
        boss_TheFallenProtectors() : CreatureScript("boss_TheFallenProtectors") { }

        struct boss_TheFallenProtectorsAI : public ScriptedAI
        {
            boss_TheFallenProtectorsAI(Creature* creature) : ScriptedAI(creature)
            {
                Initialize();
            }
        ...
        {
            return new boss_TheFallenProtectorsAI(creature);
        }
};

void AddSC_boss_TheFallenProtectors()
{
    new boss_TheFallenProtectors();
}
