...
class boss_Council : public CreatureScript
{
    public:
        boss_Council() : CreatureScript("boss_Council") { }

        struct boss_CouncilAI : public ScriptedAI
        {
            boss_CouncilAI(Creature* creature) : ScriptedAI(creature)
            {
                Initialize();
            }
        ...
        {
            return new boss_CouncilAI(creature);
        }
};
