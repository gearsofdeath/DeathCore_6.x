...
class boss_IronQon : public CreatureScript
{
    public:
        boss_IronQon() : CreatureScript("boss_IronQon") { }

        struct boss_IronQonAI : public ScriptedAI
        {
            boss_IronQonAI(Creature* creature) : ScriptedAI(creature)
            {
                Initialize();
            }
        ...
        {
            return new boss_IronQonAI(creature);
        }
};
