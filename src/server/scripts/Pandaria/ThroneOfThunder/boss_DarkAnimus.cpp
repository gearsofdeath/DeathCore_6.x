...
class boss_DarkAnimus : public CreatureScript
{
    public:
        boss_DarkAnimus() : CreatureScript("boss_DarkAnimus") { }

        struct boss_DarkAnimusAI : public ScriptedAI
        {
            boss_DarkAnimusAI(Creature* creature) : ScriptedAI(creature)
            {
                Initialize();
            }
        ...
        {
            return new boss_DarkAnimusAI(creature);
        }
};
