...
class boss_trial_of_king : public CreatureScript
{
    public:
        boss_trial_of_king() : CreatureScript("boss_trial_of_king") { }

        struct boss_trial_of_kingAI : public ScriptedAI
        {
            boss_trial_of_kingAI(Creature* creature) : ScriptedAI(creature)
            {
                Initialize();
            }
        ...
        {
            return new boss_trial_of_kingAI(creature);
        }
};

void AddSC_boss_trial_of_king()
{
    new boss_trial_of_king();
}
