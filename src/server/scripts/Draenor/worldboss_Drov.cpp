...
class worldboss_Drov : public CreatureScript
{
    public:
        worldboss_Drov() : CreatureScript("worldboss_Drov") { }

        struct worldboss_DrovAI : public ScriptedAI
        {
            worldboss_DrovAI(Creature* creature) : ScriptedAI(creature)
            {
                Initialize();
            }
        ...
        {
            return new worldboss_DrovAI(creature);
        }
};
