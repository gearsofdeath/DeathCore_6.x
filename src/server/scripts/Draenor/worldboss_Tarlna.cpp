...
class worldboss_Tarlna : public CreatureScript
{
    public:
        worldboss_Tarlna() : CreatureScript("worldboss_Tarlna") { }

        struct worldboss_TarlnaAI : public ScriptedAI
        {
            worldboss_TarlnaAI(Creature* creature) : ScriptedAI(creature)
            {
                Initialize();
            }
        ...
        {
            return new worldboss_TarlnaAI(creature);
        }
};

void AddSC_worldboss_Tarlna()
{
    new worldboss_Tarlna();
}
