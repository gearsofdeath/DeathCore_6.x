...
class boss_Kagraz : public CreatureScript
{
    public:
        boss_Kagraz() : CreatureScript("boss_Kagraz") { }

        struct boss_KagrazAI : public ScriptedAI
        {
            boss_KagrazAI(Creature* creature) : ScriptedAI(creature)
            {
                Initialize();
            }
        ...
        {
            return new boss_KagrazAI(creature);
        }
};
