...
class boss_TheIronMaidens : public CreatureScript
{
    public:
        boss_TheIronMaidens() : CreatureScript("boss_TheIronMaidens") { }

        struct boss_TheIronMaidensAI : public ScriptedAI
        {
            boss_TheIronMaidensAI(Creature* creature) : ScriptedAI(creature)
            {
                Initialize();
            }
        ...
        {
            return new boss_TheIronMaidensAI(creature);
        }
};

void AddSC_boss_TheIronMaidens()
{
    new boss_TheIronMaidens();
}
