...
class boss_HansgarAndFranzok : public CreatureScript
{
    public:
        boss_HansgarAndFranzok() : CreatureScript("boss_HansgarAndFranzok") { }

        struct boss_HansgarAndFranzokAI : public ScriptedAI
        {
            boss_HansgarAndFranzokAI(Creature* creature) : ScriptedAI(creature)
            {
                Initialize();
            }
        ...
        {
            return new boss_HansgarAndFranzokAI(creature);
        }
};

void AddSC_boss_HansgarAndFranzok()
{
    new boss_HansgarAndFranzok();
}
