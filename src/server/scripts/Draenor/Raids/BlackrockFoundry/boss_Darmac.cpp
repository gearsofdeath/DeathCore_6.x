...
class boss_Darmac : public CreatureScript
{
    public:
        boss_Darmac() : CreatureScript("boss_Darmac") { }

        struct boss_DarmacAI : public ScriptedAI
        {
            boss_DarmacAI(Creature* creature) : ScriptedAI(creature)
            {
                Initialize();
            }
        ...
        {
            return new boss_DarmacAI(creature);
        }
};
