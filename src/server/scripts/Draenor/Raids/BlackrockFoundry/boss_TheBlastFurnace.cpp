...
class boss_TheBlastFurnace : public CreatureScript
{
    public:
        boss_TheBlastFurnace() : CreatureScript("boss_TheBlastFurnace") { }

        struct boss_TheBlastFurnaceAI : public ScriptedAI
        {
            boss_TheBlastFurnaceAI(Creature* creature) : ScriptedAI(creature)
            {
                Initialize();
            }
        ...
        {
            return new boss_TheBlastFurnaceAI(creature);
        }
};

void AddSC_boss_TheBlastFurnace()
{
    new boss_TheBlastFurnace();
}
