...
class boss_Thogar : public CreatureScript
{
    public:
        boss_Thogar() : CreatureScript("boss_Thogar") { }

        struct boss_ThogarAI : public ScriptedAI
        {
            boss_ThogarAI(Creature* creature) : ScriptedAI(creature)
            {
                Initialize();
            }
        ...
        {
            return new boss_ThogarAI(creature);
        }
};
