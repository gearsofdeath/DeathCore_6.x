...
class boss_Ragewing : public CreatureScript
{
    public:
        boss_Ragewing() : CreatureScript("boss_Ragewing") { }

        struct boss_RagewingAI : public ScriptedAI
        {
            boss_RagewingAI(Creature* creature) : ScriptedAI(creature)
            {
                Initialize();
            }
        ...
        {
            return new boss_RagewingAI(creature);
        }
};
