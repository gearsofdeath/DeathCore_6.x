...
class boss_Gorashan : public CreatureScript
{
    public:
        boss_Gorashan() : CreatureScript("boss_Gorashan") { }

        struct boss_GorashanAI : public ScriptedAI
        {
            boss_GorashanAI(Creature* creature) : ScriptedAI(creature)
            {
                Initialize();
            }
        ...
        {
            return new boss_GorashanAI(creature);
        }
};
