...
class boss_Tharbek : public CreatureScript
{
    public:
        boss_Tharbek() : CreatureScript("boss_Tharbek") { }

        struct boss_TharbekAI : public ScriptedAI
        {
            boss_TharbekAI(Creature* creature) : ScriptedAI(creature)
            {
                Initialize();
            }
        ...
        {
            return new boss_TharbekAI(creature);
        }
};
