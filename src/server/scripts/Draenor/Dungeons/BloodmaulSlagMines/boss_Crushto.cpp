...
class boss_Crushto : public CreatureScript
{
    public:
        boss_Crushto() : CreatureScript("boss_Crushto") { }

        struct boss_CrushtoAI : public ScriptedAI
        {
        ...
        {
            return new boss_CrushtoAI(creature);
        }
};
