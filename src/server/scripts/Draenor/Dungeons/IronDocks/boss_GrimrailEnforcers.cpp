...
class boss_GrimrailEnforcers : public CreatureScript
{
    public:
        boss_GrimrailEnforcers() : CreatureScript("boss_GrimrailEnforcers") { }

        struct boss_GrimrailEnforcersAI : public ScriptedAI
        {
            boss_GrimrailEnforcersAI(Creature* creature) : ScriptedAI(creature)
            {
                Initialize();
            }
        ...
        {
            return new boss_GrimrailEnforcersAI(creature);
        }
};

void AddSC_boss_GrimrailEnforcers()
{
    new boss_GrimrailEnforcers();
}
