...
class boss_SadanaBloodfury : public CreatureScript
{
    public:
        boss_SadanaBloodfury() : CreatureScript("boss_SadanaBloodfury") { }

        struct boss_SadanaBloodfuryAI : public ScriptedAI
        {
            boss_SadanaBloodfuryAI(Creature* creature) : ScriptedAI(creature)
            {
                Initialize();
            }
        ...
        {
            return new boss_SadanaBloodfuryAI(creature);
        }
};

void AddSC_boss_SadanaBloodfury()
{
    new boss_SadanaBloodfury();
}
