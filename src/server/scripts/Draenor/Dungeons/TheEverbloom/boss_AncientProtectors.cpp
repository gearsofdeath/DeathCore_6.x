...
class boss_AncientProtectors : public CreatureScript
{
    public:
        boss_AncientProtectors() : CreatureScript("boss_AncientProtectors") { }

        struct boss_AncientProtectorsAI : public ScriptedAI
        {
            boss_AncientProtectorsAI(Creature* creature) : ScriptedAI(creature)
            {
                Initialize();
            }
        ...
        {
            return new boss_AncientProtectorsAI(creature);
        }
};

void AddSC_boss_AncientProtectors()
{
    new boss_AncientProtectors();
}
