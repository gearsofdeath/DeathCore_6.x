...
class boss_ArchmageSol : public CreatureScript
{
    public:
        boss_ArchmageSol() : CreatureScript("boss_ArchmageSol") { }

        struct boss_ArchmageSolAI : public ScriptedAI
        {
            boss_ArchmageSolAI(Creature* creature) : ScriptedAI(creature)
            {
                Initialize();
            }
        ...
        {
            return new boss_ArchmageSolAI(creature);
        }
};

void AddSC_boss_ArchmageSol()
{
    new boss_ArchmageSol();
}
