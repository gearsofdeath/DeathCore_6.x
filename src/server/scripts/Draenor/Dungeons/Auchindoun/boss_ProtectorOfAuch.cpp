...
class boss_ProtectorOfAuch : public CreatureScript
{
    public:
        boss_ProtectorOfAuch() : CreatureScript("boss_ProtectorOfAuch") { }

        struct boss_ProtectorOfAuchAI : public ScriptedAI
        {
            boss_ProtectorOfAuchAI(Creature* creature) : ScriptedAI(creature)
            {
                Initialize();
            }
        ...
        {
            return new boss_ProtectorOfAuchAI(creature);
        }
};

void AddSC_boss_ProtectorOfAuch()
{
    new boss_ProtectorOfAuch();
}
