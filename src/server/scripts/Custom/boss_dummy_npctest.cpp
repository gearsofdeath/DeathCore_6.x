...
class boss_dummy_npctest : public CreatureScript
{
public:
    boss_dummy_npctest() : CreatureScript("boss_dummy_npctest") { }

    CreatureAI* GetAI(Creature* creature) const OVERRIDE
    {
        return new boss_dummy_npctestAI(creature);
    }

    struct boss_dummy_npctestAI : public ScriptedAI
    {
        boss_dummy_npctestAI(Creature* creature) : ScriptedAI(creature) { }
...
void AddSC_boss_dummy_npctest()
{
    new boss_dummy_npctest();
}
